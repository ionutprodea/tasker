      ...
      <div className="m-5 centered-container">
        <section className="text-container">
          <p className="text mb-4">
            Tasker is a simple yet functional to-do application designed to help
            you manage tasks efficiently. The app allows you to add new tasks,
            delete completed or irrelevant ones, and view all your tasks in an
            organized manner. It also includes sorting features to better manage
            your list.
          </p>
          <p className="text mb-4">
          ...
          <p className="text mb-4">
            ...
            in your browser's memory (local storage). Please note that clearing
            the local storage will result in the loss of all your tasks.
          </p>
          <p className="text mb-4">
